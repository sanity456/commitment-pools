...
The app exposes separate Explore, Participant, Creator, and Owner experiences. Owner controls are limited to the future fee schedule; the contract enforces the real authority boundary.

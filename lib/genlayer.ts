...
// Browser-only adapter for the pinned CommitmentPoolV2 deployment.
...
export async function writeContract(
  ...
  if (!isLiveConfigured) {
    throw new Error(
      "Preview mode cannot submit transactions. Configure the RPC URL and CommitmentPoolV2 address first.",
    );
  }
  await ensureNetwork();

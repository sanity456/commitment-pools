...
export const contractAddress = String(process.env.NEXT_PUBLIC_COMMITMENT_POOL_ADDRESS ?? deployment.contractAddress).trim();
...
async function verifyRpc() {
  if (!isLiveConfigured) throw new Error("The Commitment Pools Studionet deployment is not configured.");

# Commitment Pools wallet release — 2026-08-28

## Deployment

- Account: `sanity456`; workspace: `sanity3`.
- [Verified wallet-only deployment](https://commitment-pools-studionet-15rc9ox38-sanity3.vercel.app)
- Deployment ID: `dpl_9EFsxRnuY2vZSEr75U79MZPMpZZf`; state: `READY`.

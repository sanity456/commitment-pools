      ...
      {Boolean(device.pending.length || device.legacy.length) && (
        <details className="product-panel">
          <summary>
            ...
            {device.legacy.length} unscoped hashes
          </summary>
          <p className="product-muted mt-3">
            Unscoped entries have no recorded contract. Check them before
            repeating an action; they are never replayed automatically.
          </p>
          <button
          ...
          {[
            ...
            >
              <p className="product-muted">
                {entry.legacy
                  ? "Contract not recorded · verification required"
